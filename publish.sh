...
# Theme CSS files (generated by project_part_4_global_variables.ipynb)
if [ -f "$PROJECT_DIR/team_theme.css" ]; then
    cp "$PROJECT_DIR/team_theme.css" "$DOCS/team_theme.css"
    echo "          ✓ team_theme.css included"
fi
if [ -f "$PROJECT_DIR/interactive_tour_theme.css" ]; then
    cp "$PROJECT_DIR/interactive_tour_theme.css" "$DOCS/interactive_tour_theme.css"
    echo "          ✓ interactive_tour_theme.css included"
fi
